...
CREATE TABLE `product_tbl` (
  ...
  `prod_name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `prod_quantity` int NOT NULL,
  `prod_mprice` decimal(10,2) NOT NULL,
  `prod_lprice` double(10,2) NOT NULL,
  `prod_categ` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
  `prod_img` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
...
CREATE TABLE `rawproducttable` (
  ...
  `stocks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_swedish_ci NOT NULL,
