                    ...
                    <div class="card-body">
                      <div class="d-flex flex-column">
                        ...
                        <h4><p class="mb-1 text-black"><?= session()->get('FirstName')?> <?= session()->get('LastName')?></p></h4><br>
                          <img src="<?= base_url()?>/coffee/userassetsimages/user/images/<?=session()->get('profile_img')?>" alt="pfp" class="rounded-circle" width="150"><br><br>
                        </div>
                        <div class="card-body">
                          <div class="row">
                            <div class="col-sm-3">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <a class="btn btn-info" href="<?= site_url("/edituserprofile/"); ?><?= session()->get('UserID')?>">Edit Profile</a>
                            </div>
                          </div>
                        </div>
                      </div>
