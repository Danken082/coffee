							...
							<div class="row">
								<div class="col-md-6">
									<div class="menu-entry">
										<a class="img" style="background-image: url(/assets/images/coffeefrappe.jpg);"></a>
									</div>
								</div>
								<div class="col-md-6">
									<div class="menu-entry mt-lg-4">
										<a class="img" style="background-image: url(/assets/images/salad.jpg);"></a>
									</div>
								</div>
								<div class="col-md-6">
									<div class="menu-entry">
										<a class="img" style="background-image: url(/assets/images/soup.jpg);"></a>
									</div>
								</div>
								<div class="col-md-6">
									<div class="menu-entry mt-lg-4">
										<a class="img" style="background-image: url(/assets/images/coffee2.jpg);"></a>
									</div>
    							</div>
    						</div>
    					</div>
				...
				<div class="container">
					<div class="row justify-content-center mb-5 pb-3">
						<div class="col-md-7 heading-section ftco-animate text-center">
							<span class="subheading">Discover</span>
							<h2 class="mb-4">Our Best Coffee Sellers</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3">
							<div class="menu-entry">
								<a class="img" style="background-image: url(/assets/images/coffee1.png);"></a>
						...
						<div class="col-md-3">
							<div class="menu-entry">
								<a class="img" style="background-image: url(/assets/images/coffee3.jpg);"></a>
								<div class="text text-center pt-4">
									...
									<div class="tab-content ftco-animate" id="v-pills-tabContent">
										<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
											<div class="row">
												...
												<div class="col-md-4 text-center">
													<div class="menu-wrap">
														<a class="menu-img img mb-4" style="background-image: url(/assets/images/pasta.jpg);"></a>
														<div class="text">
															<h3><a>Carbonara</a></h3>
												...
												<div class="col-md-4 text-center">
													<div class="menu-wrap">
														<a class="menu-img img mb-4" style="background-image: url(/assets/images/appetizer.jpg);"></a>
														<div class="text">
															<h3><a>Classic Ceasar</a></h3>
