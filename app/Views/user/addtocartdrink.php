    ...
    <body>
        <div class="container">
            ...
            <label for="ProductName" style="font-size:30px"><?= $cart['prod_name'] ?></label>
                ...
                <label for="Medium" name="prod_mprice" value="<?= $cart['prod_mprice'] ?>">Medium: ₱ <?= $cart['prod_mprice'] ?></label>
                <label for="Large" name="prod_lprice" value="<?= $cart['prod_lprice'] ?>">Large: ₱ <?= $cart['prod_lprice'] ?></label>
