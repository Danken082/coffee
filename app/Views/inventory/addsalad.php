            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3">Add Salad</h6>
                    </div>
                </div>

                <div class="card-body px-4 pb-3">
                <form action="<?= base_url('addsalad')?>" class="row g-3" method="POST">
                        ...
                        <input type="hidden" name="prod_categ" value="Salad">
                        ...
                        <div class="input-group input-group-outline my-3">
                            <button type="submit" class="btn btn-success">Add Salad</button>
                        </div>
                        <div><a href="<?= base_url('/inventorysalad')?>" class="btn btn-info">BACK</a></div>
                    </form>
                </div>
            </div>
        </div>
