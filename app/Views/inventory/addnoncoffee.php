    ...
    <body>
        <div class="col-md-12">
            ...
            <div class="card my-4">
                ...
                <form action="<?= base_url('addnon')?>" class="row g-3" method="POST">
                        ...
                        <input type="hidden" name="prod_categ" value="Non Coffee Frappe">
                        ...
                        <div><a href="<?= base_url('/inventorynoncoffee')?>" class="btn btn-info">BACK</a></div>
                    </form>
                </div>
            </div>
        </div>
