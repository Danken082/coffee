                ...
                <div class="card-body px-4 pb-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group input-group-outline my-3">
                                <input type="number" class="form-control" id="quantity" name="prod_quantity" value="<?=$ehot['prod_quantity'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label for="Medium" class="form-label">Price</label>
                            <div class="input-group input-group-outline my-3">
                                <input type="text" class="form-control" id="medium" name="prod_mprice" value="<?=$ehot['prod_mprice'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label for="Barcode" class="form-label">BarCode</label>
                            <div class="input-group input-group-outline my-3">
                                <input type="text" class="form-control" id="barcode" name="prod_code" value="<?=$ehot['prod_code'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label for="Images" class="form-label">Images</label>
                            <div class="input-group input-group-outline my-3">
                                <input type="file" id="images" name="prod_img" value="<?=$ehot['prod_img'] ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group input-group-outline my-3">
