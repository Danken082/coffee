...
<html lang="en">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="background-color: transparent; color:white; font-size: 1.5em;">Equipment List</li>
    </ol><br><br>
        <div class="card-body">
                        ...
                        <?php foreach($item as $i): ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?= base_url('/editequip/' .$i['rawID']) ?>" id='id'
