            ...
            <div class="card-body px-4 pb-3">
                <form action="<?= base_url('/updateflavored/'. $eflav['prod_id'])?>" class="row g-3" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group input-group-outline my-3">
                            <input type="text" class="form-control" id="description" name="prod_desc" value="<?=$eflav['prod_desc'] ?>">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <label for="Quantity" class="form-label">Quantity</label>
                        <div class="input-group input-group-outline my-3">
                            <input type="number" class="form-control" id="quantity" name="prod_quantity" min="1" value="<?=$eflav['prod_quantity'] ?>">
                        </div>
                    </div>
                    <div class="col-md-5">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group input-group-outline my-3">
                                <input type="number" class="form-control" id="large" name="prod_lprice" min="0" value="<?=$eflav['prod_lprice'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="col-12 text-center">
                        <button type="submit" class="btn btn-success" style="background-color: #1167b1;; color: white;">Update Flavored Coffee</button>
                    </div>
                </form>
            </div>
        </div>
