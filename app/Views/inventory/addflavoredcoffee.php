    ...
    <body>
        <div class="col-md-12">
            ...
            <div class="card my-4">
                ...
                <form action="<?= base_url('addflavored')?>" class="row g-3" method="POST">
                        ...
                        <input type="hidden" name="prod_categ" value="Flavored Coffee">
                        ...
                        <div><a href="<?= base_url('/inventoryflavoredcoffee')?>" class="btn btn-info">BACK</a></div>
                    </form>
                </div>
            </div>
        </div>
