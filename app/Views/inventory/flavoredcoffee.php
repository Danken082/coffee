...
<html lang="en">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="background-color: transparent; color:white; font-size: 1.5em;">Flavored Coffee List</li>
    </ol><br><br>
        <div class="card-body">
                        ...
                        <?php foreach($prod as $p): ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?= base_url('/editflavored/' .$p['prod_id']) ?>" id='id'
                                        class="text-info font-weight-bold text-xs me-2"
                                        data-toggle="tooltip" data-original-title="Edit Coffee">
                                        Edit
                                    </a>||
                                    <a href="<?= base_url('/deleteflavored/' .$p['prod_id']) ?>" class="text-danger font-weight-bold text-xs delete-link"
                                        id='id' data-toggle="tooltip" data-original-title="Delete Coffee">Delete</a>
                                </td>
                                <td>
                                    <form action="<?= base_url('/availableflavored/')?>" method="POST">
                                    ...
                                    <br>
                                    <form action="<?= base_url('/unavailableflavored/')?>" method="POST">
                                        <input type="hidden" name="update" value="<?= $p['prod_id']?>">
