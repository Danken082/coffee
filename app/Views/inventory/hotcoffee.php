...
<html lang="en">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="background-color: transparent; color:white; font-size: 1.5em;">Hot Coffee List</li>
    </ol><br><br>
        <div class="card-body">
                        ...
                        <?php foreach($prod as $p): ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <a href="<?= base_url('/deletehot/' . $p['prod_id']) ?>" class="text-danger font-weight-bold text-xs delete-link" data-toggle="tooltip" data-original-title="Delete Coffee">Delete</a>
                                </td>
                                <td>
