...
<html lang="en">
    ...
    <body>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="background-color: transparent; color:white; font-size: 1.5em;">Appetizer List</li>
        </ol><br><br>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach($prod as $a): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="text-xs  font-weight-bold"><?=$a['prod_name'] ?></p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold"><?=$a['prod_desc'] ?></p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs  font-weight-bold"><?=$a['prod_quantity'] ?></p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs  font-weight-bold">₱ <?=$a['prod_mprice'] ?></p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs  font-weight-bold"><?=$a['prod_code'] ?></p>
                                </td>
                                <td class="align-middle text-center">
                                    ...
                                    <a href="<?= base_url('/deleteappetizer/' .$a['prod_id']) ?>" class="text-danger font-weight-bold text-xs delete-link"
                                ...
                                <br>
                                <form action="<?= base_url('/unavailableappetizer/')?>" method="POST">
                                    <input type="hidden" name="update" value="<?= $a['prod_id']?>">
