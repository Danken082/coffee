            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div
                        ...
                        <h6 class="text-white text-capitalize ps-3">Add Soup</h6>
                    </div>
                </div>

                <div class="card-body px-4 pb-3">
                <form action="<?= base_url('addsoup')?>" class="row g-3" method="POST">
                        ...
                        <input type="hidden" name="prod_categ" value="Soup">
                        ...
                        <div class="input-group input-group-outline my-3">
                            <button type="submit" class="btn btn-success">Add Soup</button>
                        </div>
                        <div><a href="<?= base_url('/inventorysoup')?>" class="btn btn-info">BACK</a></div>
                    </form>
                </div>
            </div>
        </div>
