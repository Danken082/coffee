                    ...
                    <form action="<?= base_url('/updateequip/'. $equip['rawID'])?>" class="row g-3" method="POST" enctype="multipart/form-data">
                        <div class="col-md-5">
                            ...
                            <div class="input-group input-group-outline my-3">
                                <input type="text" class="form-control" id="name" name="name" value="<?=$equip['name'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label for="Stocks" class="form-label">Stocks</label>
                            <div class="input-group input-group-outline my-3">
                                <input type="number" class="form-control" id="stocks" name="stocks" min="1" value="<?=$equip['stocks'] ?>">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label for="Barcode" class="form-label">BarCode</label>
                            <div class="input-group input-group-outline my-3">
                                <input type="text" disabled class="form-control" id="barcode" name="barcode" value="<?=$equip['barcode'] ?>">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-group input-group-outline my-3">
