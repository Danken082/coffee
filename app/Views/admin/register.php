...
<script type="module">
        ...
        navigator.serviceWorker.register("<?= base_url()?>js/sw.js").then(registration => {
            getToken(messaging, {
                ...
                vapidKey: 'BAbyPy7ejsez4L0T7_UAIR8G3KHAsYYdCIxKBCE99HsFDT4K2dCWTB5UTav60tf7jFx74sexGWZ9bKlPhS22C6U' 
            }).then((currentToken) => {
                if (currentToken) {
                    console.log("Token is: " + currentToken);
                    document.getElementById('fcmToken').value = currentToken; // Set the token in the hidden input
                } else {
