...
<body>
        ...
        <div class="main-body">
          ...
          <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <form action="<?= base_url('/updateuser/'. $euser['UserID'])?>" class="row g-3" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="upload">
                        <img src="/assets/user/images/<?php echo $euser['profile_img']?>" alt="pfp" id="profile" class="rounded-circle" width="150">
      ...
      <script type="text/javascript">
        ...
        document.getElementById("cancel").onclick = function(){;
          ...
          xhr.open('GET', '<?= base_url('/removeprofile/'. $euser['UserID'])?>');
          xhr.send();
      };
      </script>
</body>
