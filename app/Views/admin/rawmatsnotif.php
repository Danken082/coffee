...
<html lang="en">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="background-color: transparent; color:white; font-size: 1.5em;">Raw Materials List</li>
    </ol><br><br>
        <div class="card-body">
                    ...
                    <tbody>
                            <tr>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold"><?=$notif['name'] ?></p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold"><?=$notif['stocks'] ?></p>
                                </td>
                   
                                <td class="align-middle text-center">
                                    <a href="<?= base_url('/editraw/' .$notif['rawID']) ?>" id='id'
                                        class="text-info font-weight-bold text-xs me-2"
                                        data-toggle="tooltip" data-original-title="Edit Coffee">
                                        Edit
                                    </a>||
                                    <a href="<?= base_url('/deleteraw/' .$notif['rawID']) ?>" class="text-danger font-weight-bold text-xs delete-link"
